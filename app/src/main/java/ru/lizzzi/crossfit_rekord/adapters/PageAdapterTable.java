...
import ru.lizzzi.crossfit_rekord.fragments.TableTL.TL1ParnasTableFragment;
import ru.lizzzi.crossfit_rekord.fragments.TableTL.TL2MyzhestvoTableFragment;
...
public class PageAdapterTable extends FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
        if (position == 0) {
            return new TL1ParnasTableFragment();
        } else if (position == 1){
            return new TL2MyzhestvoTableFragment();
        } else {
            return null;
        }
    }
